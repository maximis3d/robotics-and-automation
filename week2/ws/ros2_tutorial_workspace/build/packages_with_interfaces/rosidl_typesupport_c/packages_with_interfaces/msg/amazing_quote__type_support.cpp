...
#include "packages_with_interfaces/msg/detail/amazing_quote__type_support.h"
...
static const _AmazingQuote_type_support_symbol_names_t _AmazingQuote_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, packages_with_interfaces, msg, AmazingQuote)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, packages_with_interfaces, msg, AmazingQuote)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, packages_with_interfaces, msg, AmazingQuote)() {
  return &::packages_with_interfaces::msg::rosidl_typesupport_c::AmazingQuote_message_type_support_handle;
}
