...
#include "packages_with_interfaces/srv/detail/what_is_the_point__type_support.h"
...
static const _WhatIsThePoint_Request_type_support_symbol_names_t _WhatIsThePoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, packages_with_interfaces, srv, WhatIsThePoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, packages_with_interfaces, srv, WhatIsThePoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, packages_with_interfaces, srv, WhatIsThePoint_Request)() {
  return &::packages_with_interfaces::srv::rosidl_typesupport_c::WhatIsThePoint_Request_message_type_support_handle;
}
...
static const _WhatIsThePoint_Response_type_support_symbol_names_t _WhatIsThePoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, packages_with_interfaces, srv, WhatIsThePoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, packages_with_interfaces, srv, WhatIsThePoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, packages_with_interfaces, srv, WhatIsThePoint_Response)() {
  return &::packages_with_interfaces::srv::rosidl_typesupport_c::WhatIsThePoint_Response_message_type_support_handle;
}
...
static const _WhatIsThePoint_type_support_symbol_names_t _WhatIsThePoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, packages_with_interfaces, srv, WhatIsThePoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, packages_with_interfaces, srv, WhatIsThePoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, packages_with_interfaces, srv, WhatIsThePoint)() {
  return &::packages_with_interfaces::srv::rosidl_typesupport_c::WhatIsThePoint_service_type_support_handle;
}
