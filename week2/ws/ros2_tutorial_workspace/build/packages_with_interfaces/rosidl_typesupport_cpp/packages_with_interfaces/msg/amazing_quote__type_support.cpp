...
static const _AmazingQuote_type_support_symbol_names_t _AmazingQuote_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, packages_with_interfaces, msg, AmazingQuote)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, packages_with_interfaces, msg, AmazingQuote)),
  }
};
...
{
  return &::packages_with_interfaces::msg::rosidl_typesupport_cpp::AmazingQuote_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, packages_with_interfaces, msg, AmazingQuote)() {
  return get_message_type_support_handle<packages_with_interfaces::msg::AmazingQuote>();
}
