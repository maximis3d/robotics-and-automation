...
#include "packages_with_interfaces/msg/detail/amazing_quote__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.philosopher_name;
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = packages_with_interfaces::msg::AmazingQuote;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const packages_with_interfaces::msg::AmazingQuote *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<packages_with_interfaces::msg::AmazingQuote *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AmazingQuote__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const packages_with_interfaces::msg::AmazingQuote *>(
...
static size_t _AmazingQuote__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AmazingQuote(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AmazingQuote__callbacks = {
  "packages_with_interfaces::msg",
  "AmazingQuote",
...
static rosidl_message_type_support_t _AmazingQuote__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AmazingQuote__callbacks,
...
{
  return &packages_with_interfaces::msg::typesupport_fastrtps_cpp::_AmazingQuote__handle;
}
