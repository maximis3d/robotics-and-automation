...
#ifndef PACKAGES_WITH_INTERFACES__SRV__DETAIL__WHAT_IS_THE_POINT__FUNCTIONS_H_
#define PACKAGES_WITH_INTERFACES__SRV__DETAIL__WHAT_IS_THE_POINT__FUNCTIONS_H_
...
#include "packages_with_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_packages_with_interfaces
bool
 ...
 * calls
 * packages_with_interfaces__srv__WhatIsThePoint_Request__init().
...
/**
 * It calls
 * packages_with_interfaces__srv__WhatIsThePoint_Request__fini()
 ...
 * packages_with_interfaces__srv__WhatIsThePoint_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * packages_with_interfaces__srv__WhatIsThePoint_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * packages_with_interfaces__srv__WhatIsThePoint_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_packages_with_interfaces
...
/**
 * It calls
 * packages_with_interfaces__srv__WhatIsThePoint_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_packages_with_interfaces
...
/**
 * It allocates the memory for the array and calls
 * packages_with_interfaces__srv__WhatIsThePoint_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_packages_with_interfaces
...
/**
 * It calls
 * packages_with_interfaces__srv__WhatIsThePoint_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PACKAGES_WITH_INTERFACES__SRV__DETAIL__WHAT_IS_THE_POINT__FUNCTIONS_H_
