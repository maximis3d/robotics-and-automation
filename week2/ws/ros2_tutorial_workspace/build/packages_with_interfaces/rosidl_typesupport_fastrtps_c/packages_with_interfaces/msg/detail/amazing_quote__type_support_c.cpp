...
#include "packages_with_interfaces/msg/detail/amazing_quote__rosidl_typesupport_fastrtps_c.h"
...
using _AmazingQuote__ros_msg_type = packages_with_interfaces__msg__AmazingQuote;
...
static uint32_t _AmazingQuote__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_packages_with_interfaces__msg__AmazingQuote(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = packages_with_interfaces__msg__AmazingQuote;
    is_plain =
      (
...
static size_t _AmazingQuote__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_packages_with_interfaces__msg__AmazingQuote(
