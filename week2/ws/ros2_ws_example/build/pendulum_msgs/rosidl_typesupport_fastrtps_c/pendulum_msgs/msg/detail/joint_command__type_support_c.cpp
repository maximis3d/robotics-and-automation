...
#include "pendulum_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum_msgs__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pendulum_msgs__msg__JointCommand(
