...
#include "pendulum_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum_msgs::msg::JointState;
    is_plain =
      (
...
{
  return &pendulum_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
