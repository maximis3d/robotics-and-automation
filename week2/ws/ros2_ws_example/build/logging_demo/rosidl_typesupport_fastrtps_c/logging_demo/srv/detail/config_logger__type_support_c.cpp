...
#include "logging_demo/srv/detail/config_logger__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // level, logger_name
#include "rosidl_runtime_c/string_functions.h"  // level, logger_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->logger_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: logger_name
  {
    ...
    if (!ros_message->logger_name.data) {
      rosidl_runtime_c__String__init(&ros_message->logger_name);
    }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = logging_demo__srv__ConfigLogger_Request;
    is_plain =
      (
...
static size_t _ConfigLogger_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_logging_demo__srv__ConfigLogger_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = logging_demo__srv__ConfigLogger_Response;
    is_plain =
      (
...
static size_t _ConfigLogger_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_logging_demo__srv__ConfigLogger_Response(
    full_bounded, is_plain, 0);
