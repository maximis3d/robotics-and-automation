...
def generate_test_description():
    ...
    process_under_test = ExecuteProcess(
        cmd=['/home/max/robotics-and-automation/week2/ws/ros2_ws/build/logging_demo/logging_demo_main'],
...
class TestLoggingDemo(unittest.TestCase):
    ...
    def test_default_severity(self, proc_output, process_under_test):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/max/robotics-and-automation/week2/ws/ros2_ws/src/demos/logging_demo/test/logging_demo_main_default_severity'
    ...
    def test_debug_severity(self, proc_output, process_under_test):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/max/robotics-and-automation/week2/ws/ros2_ws/src/demos/logging_demo/test/logging_demo_main_debug_severity'
            ), process=process_under_test, output_filter=TestLoggingDemo.output_filter, timeout=30
        )
