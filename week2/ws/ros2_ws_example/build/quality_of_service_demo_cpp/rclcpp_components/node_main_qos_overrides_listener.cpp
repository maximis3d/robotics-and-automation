...
#define NODE_MAIN_LOGGER_NAME "qos_overrides_listener"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libqos_overrides.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<quality_of_service_demo::QosOverridesListener>";
