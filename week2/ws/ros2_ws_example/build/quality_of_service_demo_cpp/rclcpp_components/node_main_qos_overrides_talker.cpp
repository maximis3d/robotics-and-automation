...
#define NODE_MAIN_LOGGER_NAME "qos_overrides_talker"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<quality_of_service_demo::QosOverridesTalker>";
