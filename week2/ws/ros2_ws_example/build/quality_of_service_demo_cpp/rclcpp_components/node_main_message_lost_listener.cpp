...
#define NODE_MAIN_LOGGER_NAME "message_lost_listener"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmessage_lost.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<quality_of_service_demo::MessageLostListener>";
