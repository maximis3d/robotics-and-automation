...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen',
            env=env)
        for i, executable in enumerate('/home/max/robotics-and-automation/week2/ws/ros2_ws/build/demo_nodes_cpp/content_filtering_publisher;/home/max/robotics-and-automation/week2/ws/ros2_ws/build/demo_nodes_cpp/content_filtering_subscriber'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/max/robotics-and-automation/week2/ws/ros2_ws/src/demos/demo_nodes_cpp/test/content_filtering_publisher;/home/max/robotics-and-automation/week2/ws/ros2_ws/src/demos/demo_nodes_cpp/test/content_filtering_subscriber'.split(';')
